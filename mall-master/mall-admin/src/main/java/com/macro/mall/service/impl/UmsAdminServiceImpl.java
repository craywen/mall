...
public class UmsAdminServiceImpl implements UmsAdminService {
    ...
    public String login(String username, String password,String verificationcode) {
        ...
        try {
            ...
            String sourceCode = String.valueOf(defaultCacheEngine.get("VALIDATE_CODE"));
		if (verificationcode == null || !verificationcode.equalsIgnoreCase(sourceCode.substring(0,4))) {
                 return "yzmcw";
